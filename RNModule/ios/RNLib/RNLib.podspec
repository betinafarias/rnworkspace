#
#  Be sure to run `pod spec lint MyFirstModuleLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/viviancrs/workspace"
  ...
  # Or just: spec.author    = "Betina Farias"
  # spec.authors            = { "Betina Farias" => "betina.defarias@thoughtworks.com" }
  # spec.social_media_url   = "https://twitter.com/Betina Farias"
  ...
  spec.source       = { :git => "https://github.com/viviancrs/workspace.git", :tag => "#{spec.version}" }
